...
initial_values_parameter <- list(strength = .8, discount = -0.1, overlap = 250L)
set_relations <- sample_HBM(real_assignment, initial_values_parameter$strength, real_discount,
...
plot(density(chain_discount@state$chain))
