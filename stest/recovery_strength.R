...
initial_values_parameter <- list(strength = .1, discount = 0.1, overlap = 250L)
set_relations <- sample_HBM(real_assignment, real_strength, initial_values_parameter$discount,
